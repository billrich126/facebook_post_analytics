...
class Hybrid_Providers_Facebook extends Hybrid_Provider_Model
{
	...
	*/
	function getUserProfile()
	{
		...
		try{ 
			$data = $this->api->api('/me?fields=name,email,first_name,last_name,friends'); 
		}
		...
		$this->user->profile->friends       = (array_key_exists('friends',$data))?$data['friends']:"";
	...
	*/
	...
	{
		try{ 
			$response = $this->api->api('/me/friends?limit=1000'); 
		}
		catch( FacebookApiException $e ){
